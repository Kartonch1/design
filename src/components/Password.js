        ...
        <div className={styles.glass}>
            ...
            <div className="title flex flex-col items-center">
                <div style={{marginLeft: "250px", marginTop: "-50px", backgroundColor: "#6366f1"}}>
                    <Button className={styles.btndocum} component={Link} to="/passwordkz">
                        kz
                    </Button>
                </div>
                    <h4 className='text-3xl font-bold'>Добрый день {apiData?.firstName || apiData?.username}</h4>
              ...
              Зайдите на свой аккаунт
                ...
                <form className='py-1' onSubmit={formik.handleSubmit}>
                    ...
                    <div className="text-center py-4">
                        <span className='text-gray-500'>Забыли пароль? <Link className='text-red-500'
                                                                             to="/recovery">Сброс</Link></span>
                    </div>
