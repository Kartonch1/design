        ...
        <div className={styles.glass} style={{ width: "55%", paddingTop: '0em'}}>
            ...
            <div className="title flex flex-col items-center">
                <div style={{marginLeft: "500px", marginTop: "50px", backgroundColor: "#6366f1"}}>
                    <Button className={styles.btndocum} component={Link} to="/registerkz">
                        kz
                    </Button>
                </div>
            ...
            <form className='py-1' onSubmit={formik.handleSubmit}>
              ...
              <div className="textbox flex flex-col items-center gap-6">
                  ...
                  <div>
                      ...
                      <label htmlFor="agree"> Регистрируясь вы соглашаетесь c  </label>
                      <a href={pdf} target="_blank" rel="noreferrer">
                          <b> публичной офертой</b>
                      </a>
                  </div>
              ...
              <div className="text-center py-4">
                  <span className='text-gray-500'>Есть аккаунт? <Link className='text-red-500'
                                                                          to="/">Логин</Link></span>
              </div>
