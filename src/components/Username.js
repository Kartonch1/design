        ...
        <div className={styles.glass}>
            ...
            <div className="title flex flex-col items-center">
                <div style={{marginLeft: "250px", marginTop: "-50px",backgroundColor: "#6366f1"}}>
                    <Button className={styles.btndocum} component={Link} to="/kz">
                        kz
                    </Button>
                </div>
                <h4 className='text-4xl font-bold'>Здравствуйте</h4>
                <span className='py-4 text-xl w-2/3 text-center text-gray-500'>
              Wolt приветствует вас
            </span>
            </div>
            ...
            <form className='py-1' onSubmit={formik.handleSubmit}>
              ...
              <div className="text-center py-4">
                <span className='text-gray-500'>Нету аккаунта?<Link className='text-red-500' to="/register">Регистрация</Link></span>
              </div>
