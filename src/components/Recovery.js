      ...
      <div className='flex justify-center items-center h-screen'style={{width: "1300px", height: "800px"}}>
        <div className={styles.glass}>
          ...
          <div className="title flex flex-col items-center">
            <h4 className='text-5xl font-bold'>Восстановление пароля</h4>
            <span className='py-4 text-xl w-2/3 text-center text-gray-500'>
                Введите код чтобы восстановить аккаунт
            </span>
          </div>
          ...
          <div className="text-center py-4">
            <span className='text-gray-500'>Не получили код? <button onClick={resendOTP} className='text-red-500'>Отправить</button></span>
          </div>
